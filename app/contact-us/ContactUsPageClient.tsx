...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <div className="w-full bg-[#FFFBF0] py-16 sm:py-20 md:py-24 relative overflow-hidden">
        {/* Decorative Circles */}
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 py-12 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
            <div className="group flex items-center gap-4 p-5 bg-gray-50/50 rounded-2xl border border-gray-200 hover:border-[#E6BC2E] hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="w-10 h-10 bg-[#FFD23F] rounded-xl flex items-center justify-center text-black">
                <Mail className="w-5 h-5" />
              </div>
              <div>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">Email Us</p>
                <p className="text-sm font-bold text-[#B8860B]">{siteConfig.emails.contact}</p>
              </div>
            </div>
            ...
            <div className="group flex items-center gap-4 p-5 bg-gray-50/50 rounded-2xl border border-gray-200 hover:border-[#E6BC2E] hover:bg-white hover:shadow-xl transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-[#B8860B]">24-48 Hours</p>
              </div>
            </div>
            ...
            <div className="group flex items-center gap-4 p-5 bg-gray-50/50 rounded-2xl border border-gray-200 hover:border-[#E6BC2E] hover:bg-white hover:shadow-xl transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-[#B8860B]">Everyday 24/7</p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-[2.5rem] shadow-[0_30px_70px_rgba(0,0,0,0.08)] p-8 sm:p-12 relative overflow-hidden">
              {/* Top Accent Line */}
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#FFD23F] via-[#FFE566] to-[#FFD23F]"></div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-[#B8860B] transition-colors duration-300">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 pr-4 py-3.5 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#FFD23F]/10 focus:border-[#FFD23F] focus:bg-white transition-all duration-300 text-gray-900 font-semibold text-sm"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <div className="absolute left-4 top-5 text-gray-300 group-focus-within:text-[#B8860B] transition-colors duration-300">
                      <MessageSquare className="w-4 h-4" />
                    </div>
                    <textarea
                      id="message"
                      ...
                      required
                      rows={4}
                      className="w-full pl-12 pr-4 py-3.5 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#FFD23F]/10 focus:border-[#FFD23F] focus:bg-white transition-all duration-300 text-gray-900 font-semibold text-sm resize-none"
                ...
                {submitStatus.message && (
                  <div className={`p-4 rounded-2xl flex items-center gap-3 animate-in fade-in slide-in-from-top-2 duration-500 ${submitStatus.type === 'success' ? 'bg-[#FFFBF0] text-[#B8860B] border border-[#FFD23F]/40' : 'bg-red-50 text-red-800 border border-red-200'
                    }`}>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full py-4 bg-[#FFD23F] hover:bg-black hover:text-white text-black font-extrabold rounded-2xl shadow-xl shadow-[#FFD23F]/10 hover:shadow-2xl hover:shadow-[#FFD23F]/20 hover:-translate-y-1 transition-all duration-500 disabled:opacity-50 disabled:translate-y-0 flex items-center justify-center gap-3 group overflow-hidden relative"
                  >
                    {isSubmitting ? (
                      <>
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-[#FFFBF0] to-[#FFD23F] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                      </>
                    )}
                  </button>
                </div>
