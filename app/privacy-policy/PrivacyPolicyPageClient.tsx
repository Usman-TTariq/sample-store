...
export default function PrivacyPolicyPage() {
  const sections = [
    {
      id: "introduction",
      icon: <Globe className="w-6 h-6 text-[#B8860B]" />,
      title: "1. Introduction",
      content: `Welcome to ${siteConfig.name} ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you have a positive experience on our website. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website ${siteConfig.url.replace('https://', '')}.`
    },
    {
      id: "collection",
    ...
    {
      id: "usage",
      icon: <Eye className="w-6 h-6 text-[#B8860B]" />,
    ...
    {
      id: "tracking",
      icon: <RefreshCw className="w-6 h-6 text-[#B8860B]" />,
    ...
    {
      id: "sharing",
      icon: <Share2 className="w-6 h-6 text-[#B8860B]" />,
    ...
    {
      id: "rights",
      icon: <Shield className="w-6 h-6 text-[#B8860B]" />,
      title: "7. Your Rights",
    ...
    {
      id: "third-party",
      icon: <Smartphone className="w-6 h-6 text-[#B8860B]" />,
    ...
    },
    {
      ...
      title: "10. Contact Us",
      content: `If you have any questions about this Privacy Policy, please contact us at ${siteConfig.emails.privacy}.`
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <div className="w-full bg-[#FFFBF0] border-b border-[#FFD23F]/40 py-16 sm:py-20 md:py-24 overflow-hidden relative">
        {/* Decorative Background Elements */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#FFE566]/20 rounded-full -mr-32 -mt-32 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#FFE566]/20 rounded-full -ml-24 -mb-24 blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10 text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Your privacy is our priority. Learn how we handle your data with transparency and care at {siteConfig.name}.
          </p>
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto">
              ...
              <div key={section.id} className="relative group">
                <div className="flex gap-4 sm:gap-6">
                  ...
                  <div className="flex-shrink-0 flex flex-col items-center">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#FFFBF0] to-[#FFFBF0] flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
                      {section.icon}
                    </div>
                    {idx < sections.length - 1 && (
                      <div className="w-px flex-1 bg-gradient-to-b from-[#FFFBF0] to-transparent my-4"></div>
                    )}
                  </div>
          ...
          {/* Quick Summary Card */}
          <div className="mt-8 bg-[#FFD23F] rounded-3xl p-8 sm:p-12 text-black shadow-2xl relative overflow-hidden">
