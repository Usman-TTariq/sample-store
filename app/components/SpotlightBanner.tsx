        ...
        <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-4 sm:space-y-6 animate-slide-in-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
              ...
              <span className="text-[#B8860B]">Top Coupons</span>
            </h2>

            {/* Text Box 1 */}
            <div className="border-2 border-dashed border-[#FFD23F]/40 rounded-lg p-4 sm:p-6 bg-[#FFFBF0]/30 relative">
            ...
            <div className="border-2 border-dashed border-[#FFD23F]/40 rounded-lg p-4 sm:p-6 bg-[#FFFBF0]/30 relative">
              ...
              <div className="ml-8">
                ...
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                  {siteConfig.name} is more than just another name in the crowded world of online shopping — it's a haven for those who love the excitement of finding premium products without the heavy price tag.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 animate-slide-in-right">
            <div className="w-full rounded-lg overflow-hidden shadow-lg bg-[#FFFBF0] p-3 sm:p-4">
