    ...
    <div className="w-full px-2 sm:px-4 md:px-6 py-6 sm:py-8 md:py-12 lg:py-16 bg-white animate-fade-in-up">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 md:mb-8 gap-3 sm:gap-4">
          ...
          <Link
            href="/blogs"
            className="bg-[#FFD23F] hover:bg-black hover:text-white text-black font-semibold px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg transition-colors flex items-center gap-2 whitespace-nowrap text-sm sm:text-base animate-slide-in-right"
          >
            See All Blogs
            ...
            article ? (
              ...
              >
                ...
                <div className="w-full sm:w-1/2 p-3 sm:p-4 md:p-5 flex flex-col relative">
                  ...
                  {article.date && (
                    <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-[#FFD23F] text-black text-[10px] sm:text-xs font-semibold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded shadow-sm">
                      {article.date}
                    </div>
                  )}
                  ...
                  {article.id ? (
                    <Link
                      ...
                      className="inline-flex items-center gap-1 sm:gap-2 border-2 border-[#FFD23F] text-[#B8860B] bg-white hover:bg-black hover:text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg transition-colors font-semibold text-xs sm:text-sm w-fit mt-auto"
                    >
                      READ MORE
